...
('00000001-0000-0000-0000-000000000001',
 ...
 1, 'The document opens by stating it was inspired by the Ritz-Carlton Leadership Center''s Foundations of Our Brand.', 'draft'),
...
('00000001-0000-0000-0000-000000000001',
 ...
 2, 'The document states it was last updated by Kenneth Lobo on 6th February 2025.', 'draft'),
...
('00000001-0000-0000-0000-000000000001',
 ...
 1, 'The document asks "What do you think? Leave feedback!" after presenting the first draft.', 'draft'),

-- chunk 1: Foundations
('00000001-0000-0000-0000-000000000002',
 'When did Doctors John and Mel Deery open their first general practice?',
 'mcq', '["2008","2010","2012","2015"]',
 2, 'The document states they set out to provide quality healthcare through their first general practice in 2012.', 'draft'),
...
('00000001-0000-0000-0000-000000000002',
 ...
 1, '"Our Why" is "Love others as you love yourself" — delivering the kind of care we''d want for our own families.', 'draft'),

('00000001-0000-0000-0000-000000000002',
 'Which of the following is NOT one of YourGP''s three core values?',
 'mcq', '["Care","Integrity","Excellence","Kaizen"]',
 1, 'YourGP''s three core values are Care, Excellence, and Kaizen (Continuous Improvement). Integrity is not listed.', 'draft'),
...
('00000001-0000-0000-0000-000000000003',
 ...
 1, 'The flywheel is "a continuous cycle of improvement, where each action builds on the last."', 'draft'),
...
('00000001-0000-0000-0000-000000000003',
 ...
 2, 'In the flywheel diagram: Retain and Attract the Right Clinicians → Invest in the Best Facilities and People.', 'draft'),
...
('00000001-0000-0000-0000-000000000003',
 ...
 2, '"The best Doctor-Patient relationships are not by chance. They are the result of carefully choosing not only the right doctors but also the right patients."', 'draft'),
...
('00000001-0000-0000-0000-000000000004',
 ...
 1, 'The Brag Book is described as "an online space where team members share thanks and recognition for each other''s contributions."', 'draft'),

('00000001-0000-0000-0000-000000000004',
 'Which goal-setting framework does YourGP use?',
 'mcq', '["KPI dashboards","Balanced Scorecard","OKR (Objectives & Key Results)","SMART goals"]',
 2, 'YourGP uses the OKR framework inspired by John Doerr, setting goals that are aligned, transparent, and accountable.', 'draft'),
...
('00000001-0000-0000-0000-000000000004',
 ...
 1, '"We don''t manage — we coach. Managers, or ''coaches,'' invest in regular, structured 1-on-1 meetings with their teams."', 'draft'),
...
('00000001-0000-0000-0000-000000000005',
 ...
 1, 'The document states these practices reinforce the core values of Care, Excellence, and Kaizen.', 'draft'),
...
('00000001-0000-0000-0000-000000000005',
 ...
 2, 'YourGP measures engagement using "the world-renowned Gallup framework."', 'draft'),
...
('00000001-0000-0000-0000-000000000005',
 ...
 2, '"We know we''re not perfect — but we are committed. Committed to learning, growing, and improving."', 'draft'),
...
('00000002-0000-0000-0000-000000000001',
 ...
 1, 'The document notes it has been replaced by capability matrices for roles across YourGP.', 'draft'),
...
('00000002-0000-0000-0000-000000000001',
 ...
 1, 'The document "serves as a foundation for the capability matrices and is recommended reading."', 'draft'),

('00000002-0000-0000-0000-000000000001',
 'Who last updated the Values and Outcome Matrix document?',
 'mcq', '["John Deery","Melian Deery","Kenneth Lobo","Aiden Chang"]',
 2, 'The document was last updated by Kenneth Lobo in February 2025.', 'draft'),
...
('00000002-0000-0000-0000-000000000002',
 ...
 1, 'In many workplaces, two people in the same role are rewarded equally even when one is leading, supporting others, and driving improvements.', 'draft'),
...
('00000002-0000-0000-0000-000000000002',
 ...
 1, 'The matrix "is totally disconnected from job titles," allowing people to grow and be recognised regardless of their role.', 'draft'),

('00000002-0000-0000-0000-000000000002',
 'Which level describes someone who is "steady, reliable, and focused" in their role?',
 'mcq', '["Skipper","Commander","Sailor","Mid-Shipman"]',
 2, 'The document uses a receptionist at "Sailor" level to illustrate someone meeting expectations — steady, reliable, and focused.', 'draft'),
...
('00000002-0000-0000-0000-000000000003',
 ...
 0, '"You can stay in the role you love and still grow, thrive, and be rewarded for your contributions."', 'draft'),
...
('00000002-0000-0000-0000-000000000003',
 ...
 2, 'The document explicitly uses this scenario to describe Skipper-level behaviour.', 'draft'),
...
('00000002-0000-0000-0000-000000000003',
 ...
 1, '"This approach also helps us have open conversations about recognition, growth, and even salary."', 'draft'),
...
('00000002-0000-0000-0000-000000000004',
 ...
 2, '"You don''t need to ''outgrow'' your role to keep progressing. You can stay in your role, build on your strengths, and still grow."', 'draft'),
...
('00000002-0000-0000-0000-000000000004',
 ...
 2, 'The document defines "YGP community = Doctors, Patients and Staff."', 'draft'),
...
('00000002-0000-0000-0000-000000000004',
 ...
 1, '"We''re committed to building a place where everyone can grow and be recognised for their impact — no matter what their job title says."', 'draft'),
...
('00000002-0000-0000-0000-000000000005',
 ...
 2, 'Sailor level Care: "The YourGP community is welcomed and acknowledged kindly" and patients/GPs experience timely, empathetic support.', 'draft'),
...
('00000002-0000-0000-0000-000000000005',
 ...
 1, 'Skipper level Care requires "systems in place to ensure consistent and reliable care experiences across the organisation."', 'draft'),
...
('00000002-0000-0000-0000-000000000005',
 ...
 1, 'Commander level Care requires team culture to reflect "care, excellence, and kaizen."', 'draft'),
...
('00000002-0000-0000-0000-000000000006',
 ...
 2, 'Sailor-level Excellence: "Processes are followed consistently" and "work outputs meet or exceed defined quality standards."', 'draft'),
...
('00000002-0000-0000-0000-000000000006',
 ...
 1, 'Skipper level Excellence: "Team roles are clearly defined."', 'draft'),
...
('00000002-0000-0000-0000-000000000006',
 ...
 2, '"Skippers actively support other Skippers by providing feedback and assisting in addressing challenges collaboratively."', 'draft'),
...
('00000002-0000-0000-0000-000000000007',
 ...
 1, 'Sailor Kaizen: "Small, incremental improvements are regularly suggested and trialled" and feedback is given and received.', 'draft'),
...
('00000002-0000-0000-0000-000000000007',
 ...
 2, 'Mid-Shipman Kaizen: "Sailors participate or lead defined improvement cycles (e.g. PDSA)."', 'draft'),
...
('00000002-0000-0000-0000-000000000007',
 ...
 1, '"Vulnerability is modelled through openness to feedback and learning from mistakes."', 'draft'),
...
('00000003-0000-0000-0000-000000000001',
 ...
 1, 'YourGP''s purpose is inspired by Jesus'' teaching to "love others as you love yourself."', 'draft'),
...
('00000003-0000-0000-0000-000000000001',
 ...
 2, 'The three core values are Caring, Excellence, and Kaizen (Continuous Improvement).', 'draft'),
...
('00000003-0000-0000-0000-000000000001',
 ...
 1, '"We build systems, teams, and environments that enable GPs to deliver world-class patient care efficiently and sustainably."', 'draft'),
...
('00000003-0000-0000-0000-000000000002',
 ...
 'mcq', '[">3.5",">4.0",">4.5",">5.0"]',
 2, 'The Staff pillar specifies "High engagement (Gallup >4.5)."', 'draft'),

('00000003-0000-0000-0000-000000000002',
 'What percentage of their time should staff dedicate to training?',
 'mcq', '["1%","2%","3%","5%"]',
 2, 'The Staff pillar specifies "Highly trained (3% of time)."', 'draft'),

('00000003-0000-0000-0000-000000000002',
 'What annual revenue growth target is set in the Outcomes pillar?',
 'mcq', '["5% p.a.","10% p.a.","15% p.a.","20% p.a."]',
 2, 'The Outcomes pillar targets "Growth of revenue 15% p.a."', 'draft'),
...
('00000003-0000-0000-0000-000000000003',
 ...
 3, 'Kenneth Lobo is the Director of Innovation, responsible for developing systems and processes.', 'draft'),
...
('00000003-0000-0000-0000-000000000003',
 ...
 1, 'John Deery (CEO): Set and communicate the vision, Set Strategy, Drive alignment, Get Results.', 'draft'),
...
('00000003-0000-0000-0000-000000000003',
 ...
 1, 'The document simply states patients should "Treat us with Dignity and Respect."', 'draft'),

-- chunk 3: Checklist
('00000003-0000-0000-0000-000000000004',
 'How many disciplines are in the Checklist for Organisational Health?',
 'mcq', '["3","4","5","6"]',
 2, 'The checklist covers 5 disciplines: Build a Cohesive Leadership Team, Create Clarity, Overcommunicate Clarity, Reinforce Clarity, and Tactical and Strategic Meetings.', 'draft'),
...
('00000003-0000-0000-0000-000000000004',
 ...
 1, '"The leadership team is small enough (three to ten people) to be effective."', 'draft'),
...
('00000003-0000-0000-0000-000000000004',
 ...
 2, '"Tactical and strategic discussions are addressed in separate meetings."', 'draft'),
...
('00000004-0000-0000-0000-000000000001',
 ...
 1, 'The 5 C''s are Competency, Coachability, Clarity, Courage, and Character.', 'draft'),
...
('00000004-0000-0000-0000-000000000001',
 ...
 2, '"Everyone at YourGP can be a leader. These standards apply regardless of your role or title."', 'draft'),
...
('00000004-0000-0000-0000-000000000001',
 ...
 2, '"These standards apply regardless of your role or title."', 'draft'),
...
('00000004-0000-0000-0000-000000000002',
 ...
 2, 'The document "draws heavily on Andy Stanley''s Next Generation Leader."', 'draft'),
...
('00000004-0000-0000-0000-000000000002',
 ...
 1, '"Nobody is expected to be all of this perfectly. What we expect is honesty about where we are."', 'draft'),
...
('00000004-0000-0000-0000-000000000002',
 ...
 2, 'The document suggests using the self-assessment specifically "Before your review: Work through the Leadership Self-Assessment honestly."', 'draft'),
...
('00000004-0000-0000-0000-000000000003',
 ...
 1, 'Character is "the product of the other four — who you become when competency, coachability, clarity, and courage are lived consistently."', 'draft'),
...
('00000004-0000-0000-0000-000000000003',
 ...
 2, 'The exact one-sentence summary is "Be clear even when you are not certain — clarity is perceived as leadership."', 'draft'),
...
('00000004-0000-0000-0000-000000000003',
 ...
 1, '"The best leaders never stop learning — and they let others help them see what they cannot."', 'draft'),
...
('00000004-0000-0000-0000-000000000004',
 ...
 1, '"The two best-kept secrets of leadership: the less you do, the more you accomplish; the less you do, the more you enable others to accomplish."', 'draft'),
...
('00000004-0000-0000-0000-000000000004',
 ...
 1, 'Careful: cerebral, calculates risk, aims for success. Fearful: emotional, avoids risk, aims to avoid failure.', 'draft'),
...
('00000004-0000-0000-0000-000000000004',
 ...
 1, 'Standard 9 lists seven "thou shalt not" items about honest leadership, starting with pretending and turning a blind eye.', 'draft'),
...
('00000004-0000-0000-0000-000000000005',
 ...
 'mcq', '["10","12","15","20"]',
 2, 'The summary lists 15 standards, one for each leadership standard in the document.', 'draft'),
...
('00000004-0000-0000-0000-000000000005',
 ...
 1, 'Standard 7 is "Communicate with clarity and say the hard things early."', 'draft'),
...
('00000004-0000-0000-0000-000000000005',
 ...
 2, '"For team huddles and quick reference — one standard per day, rotating through."', 'draft'),
...
('00000005-0000-0000-0000-000000000001',
 ...
 1, 'The BHAG is "Meaningfully impact health outcomes for all Australia."', 'draft'),
...
('00000005-0000-0000-0000-000000000001',
 ...
 2, 'The four strategic goals are: GP pipeline, engaged staff & GPs, 6% sustainability, and develop bench strength. Expansion to Sydney/Melbourne is not listed.', 'draft'),

('00000005-0000-0000-0000-000000000001',
 'What is the profit margin target on patient fees in the 2025 goals?',
 'mcq', '["3%","4%","5%","6%"]',
 3, 'Strategic Goal 3 is "Increase sustainability to 6% on patient fees."', 'draft'),

-- chunk 1: KPAs
('00000005-0000-0000-0000-000000000002',
 'What is the target NPS score for GPs in the 2025 KPAs?',
 'mcq', '[">60",">70",">80",">90"]',
 2, 'The target is "Raving GPs NPS > 80."', 'draft'),

('00000005-0000-0000-0000-000000000002',
 'What patient NPS target is set in the 2025 KPAs?',
 'mcq', '[">70",">75",">80",">85"]',
 3, 'The target is "Raving Patients NPS>85."', 'draft'),
...
('00000005-0000-0000-0000-000000000002',
 ...
 1, 'Staff KPA includes: #One-on-Ones, Gallup Q12 Scores >4.5, and Highly trained.', 'draft'),

-- chunk 2: Key Results
('00000005-0000-0000-0000-000000000003',
 'How many new GPs are targeted to join YourGP in 2025?',
 'mcq', '["5","8","10","15"]',
 2, 'Key Result 1: "10 new GPs joining us."', 'draft'),

('00000005-0000-0000-0000-000000000003',
 'How many new practices is YourGP aiming to identify in 2025?',
 'mcq', '["1","2","3","4"]',
 1, 'Key Result 4: "Identify our next 2 practices."', 'draft'),
...
('00000005-0000-0000-0000-000000000003',
 ...
 2, 'Key Result 11: "Complete accountability and visibility of our operations."', 'draft'),
...
('00000006-0000-0000-0000-000000000001',
 ...
 'mcq', '["January 2026","February 2026","March 2026","April 2026"]',
 2, 'The chart was last updated on 5th March 2026.', 'draft'),

('00000006-0000-0000-0000-000000000001',
 'How many doctors does YourGP have?',
 'mcq', '["24","36","48","60"]',
 2, 'The org chart shows 48 Doctors (Independent Practitioners & Registrars).', 'draft'),
...
('00000006-0000-0000-0000-000000000001',
 ...
 1, 'The org chart describes Doctors as "Independent Medical Practitioners & Registrars."', 'draft'),

-- chunk 1: Clinic Teams
('00000006-0000-0000-0000-000000000002',
 'How many clinic locations does YourGP operate?',
 'mcq', '["1","2","3","4"]',
 2, 'There are three clinic teams: YourGP@Crace, YourGP@Denman Prospect, and YourGP@Lyneham.', 'draft'),
...
('00000006-0000-0000-0000-000000000002',
 ...
 2, 'Only Denman Prospect lists an "Assistant Site Manager" in its structure.', 'draft'),
...
('00000006-0000-0000-0000-000000000002',
 ...
 1, 'All three clinics list a "Head Nurse" in their team structure.', 'draft'),
...
('00000006-0000-0000-0000-000000000003',
 ...
 2, 'The Practice Support Team is described as "in service of Clinic Teams."', 'draft'),
...
('00000006-0000-0000-0000-000000000003',
 ...
 2, 'Practice Support Staff are based in Malaysia.', 'draft'),
...
('00000006-0000-0000-0000-000000000003',
 ...
 2, 'The Business Team consists of Head of Finance and Head of Projects & Digital Innovation.', 'draft'),

-- chunk 3: Structure
('00000006-0000-0000-0000-000000000004',
 'How many clinic staff does YourGP have in total?',
 'mcq', '["12","16","24","32"]',
 2, '"Total: 48 Doctors, 24 Staff, 8 Nurses, 5 Business Team."', 'draft'),

('00000006-0000-0000-0000-000000000004',
 'How many nurses does YourGP employ?',
 'mcq', '["5","6","8","10"]',
 2, 'The org chart total lists 8 Nurses.', 'draft'),
...
('00000006-0000-0000-0000-000000000004',
 ...
 1, '"Contact for feedback: Kenneth Lobo & Atif Wan."', 'draft');
